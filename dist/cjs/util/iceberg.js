...
exports.getIcebergS3FilesStmts = getIcebergS3FilesStmts;
 ...
 */
function getIcebergS3FilesStmts(baseS3url, prefix, _offset = 0) {
    const stmts = [];
    const offset = _offset < 0 ? 0 : _offset;
    const id = prefix ?? "a" + (0, uuid_1.v4)().replaceAll("-", "");
    const s3path = baseS3url.endsWith("/") ? baseS3url : baseS3url + "/";
    stmts.push("INSTALL avro FROM community", "LOAD avro", 
